function decode(bits) {
	if(bits.length==5){
		var z4 = parity(bits[3] + bits[4]);
		var z2 = parity(bits[1] + bits[2]);
		var z1 = parity(bits[0] + bits[2]);
	...
	if(bits.length==10){
		var z8 = parity(bits[7] + bits[8] + bits[9]);
		var z4 = parity(bits[3] + bits[4] + bits[5] + bits[6]);
		var z2 = parity(bits[1] + bits[2] + bits[5] + bits[6] + bits[9]);
		var z1 = parity(bits[0] + bits[2] + bits[4] + bits[6] + bits[8]);
